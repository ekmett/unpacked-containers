...
import qualified HashMap.Base as HM
import HashMap.Base hiding (
...
unsafeInsertWith :: (v -> v -> v) -> Key -> v -> HashMap v -> HashMap v
...
unionWith :: (v -> v -> v) -> HashMap v -> HashMap v
          -> HashMap v
...
-- maps.
intersectionWith :: (v1 -> v2 -> v3) -> HashMap v1 -> HashMap v2 -> HashMap v3
...
-- the provided function is used to combine the values from the two
-- maps.
intersectionWithKey :: (Key -> v1 -> v2 -> v3) -> HashMap v1 -> HashMap v2 -> HashMap v3
